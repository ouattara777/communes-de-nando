...
map.getView().fit([-536229.044083, 1144774.689619, 128348.996202, 1481717.428375], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">DENSITE DES COMMUNES DE LA REGION DE NANDO</h2>';
        return titleElement;
    })(),
